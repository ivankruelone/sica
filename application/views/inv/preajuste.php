<section class="grid_12">
    <div class="block-border">
        ...
        <div class="block-content">
            ...
            <h2 align="center"><?php echo $etiq; ?></h2>
            
            <h2 align="center">Productos en area: <?php echo count($query); ?></h2>
            ...
            <table class="table sortable" cellspacing="0" width="100%">
                    ...
                    ?>
						<tr>
							...
							<td align="right"><span id="invant_<?php echo $row->id?>"><?php echo $row->inv;?></span></td>
							<td align="right"><span id="invnue_<?php echo $row->id?>"></span></td>
							<td align="right"><span id="dif_<?php echo $row->id?>"></span></td>
