...
$(document).ready(function(){
    ...
    var url = "<?php echo site_url();?>/welcome/get_plaza_combo_editar";
    var variables = {
        zona: $('#zona').attr('value'),
        plaza: <?php echo $row->plaza?>
    };
    $.post( url, variables, function(data) {
        $('#plaza').html(data);
    });
    
    $('#<?php echo $row->prioridad;?>').attr('checked', true);
...
$('#nuevo_cliente_form').submit(function(event)
{
    ...
    var url = "<?php echo site_url();?>/clientes/submit_editar_cliente";
